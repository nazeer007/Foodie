...
error_reporting(0);
$query= "SELECT * FROM restaurant04 WHERE id='$id'";
...
$query = "UPDATE restaurant04 set fullname='$fullname',email='$email',phone='$phone',address='$address',pincode='$pincode',quantity='$qty',item='$item',cost='$cst',Status='$status' WHERE id='$id'";
