                        ...
                        <td class="userdetails">
                            <div class="readonly1">
                                <p>
                                    ...
                                    <input type="text" value="turkey-fajitas" id="item" name="item" style="border:none; width:90px;" readonly><br>
                                </p>
                                <p>
                            ...
                            <img src="dishes 4/turkey-fajitas.jpg">
                            <p>
...
$query="INSERT INTO RESTAURANT04 (fullname,email, phone,address,pincode,item,cost,quantity,Status) VALUES ('$fullname','$email','$phone','$address','$pincode','$item','$cst','$qty','$ds')";
