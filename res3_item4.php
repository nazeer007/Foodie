                        ...
                        <td class="userdetails">
                            <div class="readonly1">
                                <p>
                                    ...
                                    <input type="text" value="Pappardelle" id="item" name="item" style="border:none; width:85px;" readonly><br>
                                </p>
                                <p>
                                    <label for="cost"><b>Cost :</b></label>
                                    <input type="number" value="60" id="cost" name="cost" style="border:none" readonly><br>    
                                </p>
                            </div>         
                            <img src="dishes 3/Pappardelle.jpg">
                            <p>
