                        ...
                        <td class="userdetails">
                            <div class="readonly1">
                                <p>
                                    ...
                                    <input type="text" value="aw-arancini" id="item" name="item" style="border:none; width:80px;" readonly><br>
                                </p>
                                <p>
                                    <label for="cost"><b>Cost :</b></label>
                                    <input type="number" value="70" id="cost" name="cost" style="border:none" readonly><br>    
                                </p>
                            </div>         
                            <img src="dishes1/aw-arancini-articleLarge.jpg">
                            <p>
