...
<body>
    ...
    <div class="row">
        <div class="column">
            <div class="res1"><a href="Restaurant-1/res1_myorders.php">
                <button>
                    <h3>Restaurant 1</h3>
                    <b>Orders :</b>
                    <?php
        ...
        <div class="column">
            <div class="res2"><a href="Restaurant-2/res2_myorders.php">
                <button>
                    <h3>Restaurant 2</h3>
                        <b>Orders :</b>
                        <?php
        ...
        <div class="column">
            <div class="res3"><a href="Restaurant-3/res3_myorders.php">
                <button>
                    <h3>Restaurant 3</h3>
                        <b>Orders :</b>
                        <?php
        ...
        <div class="column">
            <div class="res4"><a href="Restaurant-4/res4_myorders.php">
                <button>
                    <h3>Restaurant 4</h3>
                        <b>Orders :</b>
                        <?php
