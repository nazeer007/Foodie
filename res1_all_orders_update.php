...
if($_POST['update']){
    ...
    $cst=$_POST['cost'];
    $status=$_POST['Status'];
    $query = "UPDATE restaurant01 set fullname='$fullname',email='$email',phone='$phone',address='$address',pincode='$pincode',quantity='$qty',item='$item',cost='$cst',Status='$status' WHERE id='$id'";   
    $data=mysqli_query($conn,$query);
    if($data){
