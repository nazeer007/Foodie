...
error_reporting(0);
$query= "SELECT * FROM restaurant2 WHERE id='$id'";
...
$query = "UPDATE restaurant2 set fullname='$fullname',email='$email',phone='$phone',address='$address',pincode='$pincode',quantity='$qty',item='$item',cost='$cst',Status='$status' WHERE id='$id'";
