                        ...
                        <td class="userdetails">
                            <div class="readonly1">
                                <p>
                                    ...
                                    <input type="text" value="philly-cheesesteak" id="item" name="item" style="border:none; width:130px;" readonly><br>
                                </p>
                                <p>
                                    <label for="cost"><b>Cost :</b></label>
                                    <input type="number" value="55" id="cost" name="cost" style="border:none" readonly><br>    
                                </p>
                            </div>         
                            <img src="dishes 3/philly-cheesesteak-3c4be15.jpg">
                            <p>
...
$query="INSERT INTO RESTAURANT03 (fullname,email, phone,address,pincode,item,cost,quantity,Status) VALUES ('$fullname','$email','$phone','$address','$pincode','$item','$cst','$qty','$ds')";
