                        ...
                        <td class="userdetails">
                            <div class="readonly1">
                                <p>
                                    ...
                                    <input type="text" value="delish-fettuccine" id="item" name="item" style="border:none; width:120px;" readonly><br>
                                </p>
                                <p>
                            ...
                            <img src="dishes1/delish-fettuccine-alfredo.jpg">
                            <p>
...
$query="INSERT INTO RESTAURANT01 (fullname,email, phone,address,pincode,item,cost,quantity,Status) VALUES ('$fullname','$email','$phone','$address','$pincode','$item','$cst','$qty','$ds')";
