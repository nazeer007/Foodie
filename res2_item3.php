                        ...
                        <td class="userdetails">
                            <div class="readonly1">
                                <p>
                                    ...
                                    <input type="text" value="fried-ravioli-bread-crumbs" id="item" name="item" style="border:none;  width:180px;" readonly><br>
                                </p>
                                <p>
                            ...
                            <img src="dishes 2/fried-ravioli-bread-crumbs.jpg">
                            <p>
